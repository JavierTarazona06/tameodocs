...
\hypersetup{
    ...
    linkcolor=tameoBlue,
    urlcolor=tameoLink,
    pdftitle={Dossier de réalisation du projet TAMEO-IA},
    pdfauthor={Projet TAMEO-IA}
}
...
\newcommand{\tameoBranding}{%
    \begin{tikzpicture}[remember picture,overlay]
        \node[anchor=north east] at ([xshift=-1.16in,yshift=-0.58in]current page.north east)
            {\includegraphics[width=1.98in]{assets/tameo-logo.png}};
        \node[anchor=north east] at ([xshift=-1.18in,yshift=-1.12in]current page.north east)
            {\includegraphics[width=2.05in,height=0.026in]{assets/tameo-bar.png}};
    \end{tikzpicture}%
}
...
\includepdf[pages=1,fitpaper=true,pagecommand={\thispagestyle{empty}}]{../SampleDossierRealisation.pdf}
\setcounter{page}{2}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{"../Rapport_PIE Benoit_Images/BlueBoat.png"}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{"../Rapport_PIE Benoit_Images/qgc.png"}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{"../Rapport_PIE Benoit_Images/archibb.jpg"}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{"../Rapport_PIE Benoit_Images/VNC.png"}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{"../Rapport_PIE Benoit_Images/BBmodif.jpeg"}
    \caption{BlueBoat modifié avec l'intégration du matériel nécessaire au système autonome.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{"../TravailLoup_Images/image1.png"}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\linewidth]{"../Rapport_PIE Benoit_Images/BBmot.jpeg"}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{"../Rapport_PIE Benoit_Images/etat PIE.jpg"}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{"../Rapport_PIE Benoit_Images/IAcourses.png"}
...
La gestion technique du projet ne s'est pas limitée à la conception et à l'intégration. En tant que directeur technique de l'association TAMEO, un suivi du budget global a été assuré. Ce budget couvrait à la fois le projet de bateau autonome, le développement de l'autre bateau engagé en classe Energy, les besoins liés au fonctionnement général de l'association et la participation au challenge.
...
\begin{itemize}
    \item manuel d'utilisation du BlueBoat modifié, déjà rendu ;
    \item rapport PIE et dossier de réalisation ;
    \item guide d'exploitation pour le pilote prévu au 21 avril 2026 ;
